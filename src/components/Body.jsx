...
const Body = () => {
  return (
    <div className="mx-20 my-8">
      <div className="flex justify-start text-gray-500 text-[18px]">
        ...
        <span className="mr-2 cursor-pointer">Flashcard</span>
        <span className="mr-2 flex flex-col justify-center">
          <svg
            width="7.41"
            height="12"
        ...
        <span className="mr-2 cursor-pointer">Mathematics</span>
        <span className="mr-2 flex flex-col justify-center">
          <svg
            width="7.41"
            height="12"
        ...
        <span className="mr-2 text-[#06286E]">Relations and Function</span>
      </div>
      <div className="my-8 text-[32px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#06286E] to-[#164EC0]">
        <h1>{"Relations and Functions ( Mathematics )"}</h1>
      </div>
      <div className="flex justify-center">
        <div className="my-8 text-[20px]">
          <span className="mx-4 px-4 py-2 font-bold border-b-[3px] border-[#000000] text-[#06286E]">
            Study
          </span>
          <span className="mx-4 px-4 text-gray-500 cursor-pointer">Quiz</span>
          <span className="mx-4 px-4 text-gray-500 cursor-pointer">Test</span>
          <span className="mx-4 px-4 text-gray-500 cursor-pointer">Game</span>
          <span className="mx-4 px-4 text-gray-500 cursor-pointer">Others</span>
        </div>
      </div>
      ...
      <div>
        <div className="h-[485px]">
          <div className="flex justify-center">
            <div className="mx-4 bg-gradient-linear rounded-3xl w-[712px] h-[393.19px] p-4">
              ...
              <span className="flex flex-col justify-center h-full text-center text-[38.26px] text-white font-[700px] transform -translate-y-8">
                9 + 6 + 7x - 2x - 3
              </span>
            </div>
          </div>
          <div className="flex justify-center">
            <div className="flex justify-between w-[712px] px-5 py-5">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[24px] font-bold mx-10 flex flex-col justify-center">
                  01/10
                </span>
                <span className="flex flex-col justify-center">
                  <svg
      ...
      <div className="flex justify-between mt-[70px]">
        <div className="flex">
          <div className="flex h-[100%] justify-center flex-col">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="absolute z-10 rounded-[50%] shadow-[0_0px_31px_rgba(8,_56,_153,_0.4)]"
            >
              <circle cx="40.3" cy="40.3" r="40.3" fill="white" />
            </svg>
            <img
              src={logoIcon}
              className="w-[44.69px] h-[34.54px] absolute z-20 ml-[23px]"
            />
          </div>
          <div className="ml-[105px]">
            <span className="text-[12.4px]">Published by</span>
            <div className="">
              <img src={logoText} className="w-[115.14px] h-[34.54px]" />
            </div>
          </div>
        </div>
        <div className="flex cursor-pointer">
          ...
          <span className="text-[28px] text-[#06286E] p-[14px] text-transparent bg-clip-text bg-gradient-to-b from-[#06286E] to-[#164EC0]">
            Create Flashcard
          </span>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between w-[848px] h-[58px] p-4 gap-0 rounded-lg border-2 border-blue-400 mb-[30px] cursor-pointer">

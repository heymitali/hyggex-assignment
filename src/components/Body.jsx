  ...
  return (
    <div className="lg:px-20 lg:py-8 2xl:px-[200px]">
      <div className="flex justify-start text-gray-500 lg:text-[18px] p-4 text-xs md:text-md 2xl:text-2xl">
        ...
        <span className="mr-2 cursor-pointer flex items-center">Flashcard</span>
        <span className="mr-2 flex flex-col justify-center">
          <svg
            width="7.41"
            height="12"
        ...
        <span className="mr-2 text-[#06286E] flex items-center">
          Relations and Function
        </span>
      </div>
      <div className="lg:my-8 my-3 lg:mx-auto mx-3 text-[18px] md:text-[24px] lg:text-[32px] 2xl:text-[40px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#06286E] to-[#164EC0]">
        <h1>{"Relations and Functions ( Mathematics )"}</h1>
      </div>

      <div className="flex justify-center">
        <div className="lg:my-8 my-6 text-[15px] lg:text-[20px] 2xl:text-[30px]">
          <span className="lg:mx-4 lg:px-4 py-2 mx-2 font-bold border-b-[3px] border-[#000000] text-[#06286E]">
            Study
          </span>
          <span className="lg:mx-4 lg:px-4 mx-2 text-gray-500 cursor-pointer">
            Quiz
          </span>
          <span className="lg:mx-4 lg:px-4 mx-2 text-gray-500 cursor-pointer">
            Test
      ...
      <div>
        <div>
          ...
          <div className="flex justify-center">
            <div className="flex justify-between w-[420px] lg:w-[712px] 2xl:w-[1000px] sm:px-5 lg:px-9 2xl:px-8 py-5">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[15px] md:text-[20px] lg:text-[24px] font-bold mx-10 flex flex-col justify-center">
                  01/10
                </span>
                <span className="flex flex-col justify-center">
                  <svg
      ...
      <div className="flex justify-between mt-[20px] md:mt-[70px]">
        <div className="flex">
          <div className="flex h-[100%] justify-center flex-col pl-4 md:pl-auto">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="absolute z-10 rounded-[50%] shadow-[0_0px_31px_rgba(8,_56,_153,_0.4)] md:w-[81px] md:h-[81px] w-[40px] h-[40px]"
            >
              <circle cx="50%" cy="50%" r="50%" fill="white" />
            </svg>
            <img
              src={logoIcon}
              className="md:w-[44.69px] md:h-[34.54px] w-[20px] h-[18px] absolute z-20 md:ml-[23px] ml-[12px]"
            />
          </div>
          <div className="md:ml-[105px] ml-[60px]">
            <span className="text-[8px] md:text-[12.4px]">Published by</span>
            <div className="">
              <img
                src={logoText}
        ...
        <div className="flex cursor-pointer">
          ...
          <span className="text-[15px] md:text-[28px] text-[#06286E] p-[14px] text-transparent bg-clip-text bg-gradient-to-b from-[#06286E] to-[#164EC0]">
            Create Flashcard
          </span>
        </div>
      </div>
